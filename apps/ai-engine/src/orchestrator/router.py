...
async def route_message_stream(context: Dict[str, Any]) -> AsyncIterator[Dict[str, Any]]:
    """
    Route a message through the LangGraph orchestrator with streaming support.
    ...
    async for chunk in _orchestrator_graph.run_stream(initial_state):
        yield chunk
